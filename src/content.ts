...
export const profile = {
  ...
  about: [
    "Hi, I’m Ayush. I work as an Associate AI Engineer at an analytics firm, and I’ll be graduating in 2026 with a B.Tech in Computer Science (AI specialization) and a CGPA of 8.65.",
    "About a year and a half ago, I made the decision to seriously pursue engineering. It wasn’t a straight path—I stumbled through hackathons, interviews, and plenty of rejections, with just a few close calls and wins along the way. But those experiences taught me something important: I enjoy building systems far more than chasing every opportunity at once. That realization shaped how I approach my career today.",
    ...
    "Now, my focus is on system architecture and inference engineering—routing, batching, KV/prefill optimizations, and making AI systems reliable at scale. At work, I’m building multi‑agent systems and MLOps pipelines, where I get to combine engineering discipline with AI research. I’m also diving deeper into inference, exploring practical reliability and optimizations, and learning from resources like Philip Kiely’s book, which helped me frame my journey in a more structured way.",
    "This journey is ongoing. I see my career as a series of experiments—each project, each blog, each system I design is a step toward understanding how to make AI infrastructure scalable and trustworthy. I’ll be sharing what I learn through blogs and projects, not just as documentation of my work, but as stories of the challenges, trade‑offs, and breakthroughs that come with building systems in the real world."
  ]
} as const;
